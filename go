...
lwlink main.obj titlescreen.obj screenutils.obj symbols.obj ramdoctor.obj videodoctor.obj sounddoctor.obj joystickdoctor.obj cassettedoctor.obj serialdoctor.obj keyboarddoctor.obj --output=cocorx.rom --raw
if ($? == 0) then
