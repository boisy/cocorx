...
lwasm menuscreen.asm --format=obj --output=menuscreen.obj --pragma=undefextern,export
...
lwasm sounddoctor.asm --format=obj --output=sounddoctor.obj --pragma=undefextern,export
...
lwlink main.obj titlescreen.obj menuscreen.obj screenutils.obj symbols.obj ramdoctor.obj videodoctor.obj sounddoctor.obj joystickdoctor.obj cassettedoctor.obj serialdoctor.obj keyboarddoctor.obj --output=cocorx.rom --raw
if ($? == 0) then
